				...
				<div class="tabcontrol">
					...
					<div id="block1">
						...
						<?php
							...
							query_posts( array( 'post_type' => APP_POST_TYPE, 'ignore_sticky_posts' => 1, 'paged' => $paged,
												//only show ads that haven't been sold
											   'meta_key' => 'cp_ad_sold', 'meta_compare' => 'NOT EXISTS') );
					...
					<div id="block3">
						...
						<?php
							...
							$paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1;
							query_posts( array( 'post_type' => APP_POST_TYPE, 'ignore_sticky_posts' => 1, 'paged' => $paged, 'orderby' => 'rand', 'meta_key' => 'cp_ad_sold', 'meta_compare' => 'NOT EXISTS' ) );
							$total_pages = max( 1, absint( $wp_query->max_num_pages ) );
						?>
